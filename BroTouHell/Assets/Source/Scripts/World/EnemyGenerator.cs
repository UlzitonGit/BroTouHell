...
public class EnemyGenerator : MonoBehaviour
{
    ...
    private void BuffEnemy()
    {
        ...
        print($"��������� ���� ��������� - {_playerStatsCount}, ���������� ��������� ���������� - {_enemiesPowerUps}");
        ...
        for (int i = 0; i < _enemiesPowerUps; i++)
        {
            ...
            if (_randomNumber < _buildStatChances)
            {
                ...
                print($"��������� ���� �������!, �� ���� ���� ��������� ���������: {_builds.GetListById(_randomWeaponBuild).GetStatsUpgradeById(_randomPowerUpId)} �� ����� {_randomWeaponBuild}, id ��������� � ����� - {_randomPowerUpId}");
            }
            else
            {
                print("��������� ������� ���� ��� ����� (������� ��)");
